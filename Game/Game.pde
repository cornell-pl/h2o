...
class Watershed {
  ...
  void initializeWithAll() {
    ...
    int[][] fcCoords = { { 5 , 11 },  { 5 , 12 },  { 5 , 13 },  { 5 , 14 },  { 6 , 10 },  { 6 , 11 },  { 6 , 12 },  { 6 , 13 },  { 6 , 14 },  { 7 , 11 },  { 7 , 12 },  { 7 , 13 },  { 9 , 15 },  { 9 , 16 },  { 9 , 17 },  { 9 , 18 },  { 9 , 19 },  { 10 , 16 },  { 10 , 17 },  { 10 , 18 },  { 11 , 17 },  { 11 , 18 },  { 23 , 13 },  { 23 , 14 },  { 23 , 15 },  { 24 , 13 },  { 24 , 14 },  { 24 , 15 },  { 25 , 14 } };
    ...
    for (int[] c: fcCoords) { 
      ...
      GAME_MAP[c[0]][c[1]].landU = fc;
    }
    for (int[] c: fmCoords) { 
      Farm fm = new Farm();
      GAME_MAP[c[0]][c[1]].landU = fm;
    }
    for (int[] c: hsCoords) { 
      House hs = new House();
      GAME_MAP[c[0]][c[1]].landU = hs;
    }
    initializeRiver2();    //Creates the river
  }
